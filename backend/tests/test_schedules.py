...
def test_list_schedules(client: TestClient, api_base_url: str):
    ...
    with patch("app.services.salt_api.salt_client.list_schedules", new_callable=AsyncMock) as mock_list:
...
def test_add_schedule(client: TestClient, api_base_url: str):
    ...
    with patch("app.services.salt_api.salt_client.add_schedule", new_callable=AsyncMock) as mock_add:
...
def test_delete_schedule(client: TestClient, api_base_url: str):
    ...
    with patch("app.services.salt_api.salt_client.delete_schedule", new_callable=AsyncMock) as mock_delete:
